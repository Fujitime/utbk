...
export const kemampuanMemahamiBacaanQuestions = [
  ...
  },
  {
    ...
    correctAnswer: "D",
    explanation:
      "Kata 'terhenti' lebih tepat karena menggambarkan kondisi barang kiriman yang tidak bergerak atau tertunda.",
  },
  {
    id: 3,
    ...
    correctAnswer: "A",
    explanation:
      "Kalimat (4) menyatakan reaksi terhadap masalah yang disebut sebelumnya, sehingga kontras → 'Namun' paling cocok.",
  },
  {
    id: 4,
  ...
  },
  {
    ...
    correctAnswer: "C",
    explanation:
      "Kalimat (6) menyebut ular ditemukan, jadi setelah itu cocok diberi keterangan kondisi ular saat ditemukan.",
  },
  {
    id: 7,
    ...
    options: [
      ...
      {
        id: "E",
        text: "Di Jalan Raya Darmo Surabaya ular sanca yang menggeliat dan berukuran 2 meter itu ditemukan warga.",
      },
    ],
    correctAnswer: "D",
  ...
  },
  {
    ...
    correctAnswer: "E",
    explanation:
      "Susunan paling logis: mulai dari kesiapan layanan (4), lalu penjelasan (3), lalu tujuan (1), dilanjutkan bonus (5), dan cara dapatnya (2).",
  },
  {
    id: 9,
    ...
    options: [
      {
        id: "A",
        text: "Dalam prakteknya, proses pengasuhan anak selalu menemui tantangan dan menuntut keseriusan, seperti pemahaman karakter anak, kesehatan anak, dan keinginan orang tua yang tidak sesuai dengan kondisi anak.",
      },
      {
        id: "B",
        text: "Dalam prakteknya, pengasuhan anak selalu menemui tantangan dan menuntut keseriusan, seperti pemahaman karakter anak, kesehatan anak dan keinginan orang tua yang tidak sesuai dengan kondisi anak.",
      },
      {
        id: "C",
        text: "Dalam praktiknya, proses pengasuhan anak selalu menemui tantangan dan menuntut keseriusan, seperti pemahaman karakter anak, kesehatan anak, dan keinginan orang tua yang tidak sesuai dengan kondisi anak.",
      },
      {
        id: "D",
        text: "Dalam praktiknya, pengasuhan anak selalu menemui tantangan dan menuntut keseriusan, seperti pemahaman karakter anak, kesehatan anak, dan keinginan orang tua yang tidak sesuai dengan kondisi anak.",
      },
      {
        id: "E",
        text: "Dalam praktiknya, pengasuhan anak selalu menemui tantangan dan menuntut keseriusan, seperti pemahaman karakter anak, kesehatan anak dan keinginan orang tua yang tidak sesuai dengan kondisi anak.",
  ...
  },
  {
    ...
    options: [
      ...
      {
        id: "E",
        text: "Dengan menimbang pentingnya pengasuhan anak, berbagai upaya untuk mendapatkan pendekatan pengasuhan terbaik selalu menjadi isu menarik untuk dibahas dalam konteks pendidikan yang dapat dijadikan sebagai bahan diskusi pada jenjang pendidikan tinggi, seperti seminar ilmiah dan pelatihan.",
      },
    ],
    correctAnswer: "A",
    explanation:
      "Kalimat A paling efektif dan koheren menyatukan ide utama dari dua kalimat (5) dan (6) tanpa kehilangan makna.",
  },
  {
    id: 12,
    ...
    options: [
      {
        id: "A",
        text: "“Kemarin kita sudah membeli nasi kucing,” kata ibu, “harusnya sekarang kita membeli nasi uduk untuk menjamu tamu dari Jakarta.”",
      },
    ...
    correctAnswer: "C",
    explanation:
      "Penulisan 'Sekolah' pada 'Kepala Sekolah' tidak perlu kapital karena bukan nama jabatan resmi atau nama diri. Meskipun berada di awal kalimat, hanya kata 'Kepala' yang perlu huruf kapital. Seharusnya: 'Kepala sekolah ...'",
  },
  {
    id: 13,
    ...
    options: [
      ...
      {
        id: "C",
        text: "Kebebasan dalam berbangsa dan bernegara adalah salah satu makna kemerdekaan bagi bangsa Indonesia.",
      },
    ...
    correctAnswer: "C",
    explanation:
      "Pernyataan C tepat mewakili isi paragraf: makna merdeka adalah kebebasan dalam kehidupan berbangsa dan bernegara.",
  },
  {
    id: 14,
    ...
    correctAnswer: "A",
    explanation:
      "Konteks paragraf tentang nilai dan makna dalam UUD 1945, jadi istilah 'ideologi bangsa Indonesia' paling sesuai.",
  },
  {
    id: 15,
    ...
    correctAnswer: "3",
    explanation:
      "Kalimat (3) menggunakan kata tidak baku atau ejaan salah seperti 'dapatkanlah' tanpa pemisahan akhiran.",
  },
  {
    id: 16,
    ...
    correctAnswer: "D",
    explanation:
      "Kata 'proses' di kalimat (6) mubazir karena konteks kalimat sudah menunjukkan tindakan yang berproses.",
  },
  {
    id: 17,
  ...
  },
  {
    ...
    options: [
      {
        id: "A",
        text: "Sebagai negara yang bergantung pada sumber energi konvensional, seperti minyak dan gas alam, pasokan dan penyaluran energi di seluruh negara diganggu oleh ketidakpastian politik yang dipicu oleh kudeta",
      },
      {
        id: "B",
        text: "Sebagai negara yang bergantung pada sumber energi konvensional, seperti minyak dan gas alam, ketidakpastian politik yang dipicu oleh kudeta mengganggu pasokan energi di seluruh negara.",
      },
      {
        id: "C",
        text: "Sebagai negara yang bergantung pada sumber energi konvensional, seperti minyak dan gas alam, kepastian politik yang dipicu oleh kudeta mengganggu pasokan energi dan distribusi energi di seluruh negara.",
      },
      {
        id: "D",
        text: "Sebagai negara yang bergantung pada sumber energi konvensional, seperti minyak dan gas alam, pasokan energi dan penyaluran energi di sebagian negara diganggu oleh ketidakpastian politik yang dipicu oleh kudeta",
      },
      {
        id: "E",
        text: "Sebagai negara yang bergantung pada sumber energi konvensional, seperti minyak dan gas alam, ketidakpastian politik yang dipicu oleh kudeta mengganggu pasokan energi dan distribusi energi di setiap negara.",
      },
    ],
    correctAnswer: "D",
    explanation:
      " kata terganggu tanpa menyebut dampak konkret, Konteks krisis energi akibat kudeta → listrik terganggu → aktivitas masyarakat ikut terganggu.",
  },
  {
    id: 19,
    text: "Pada teks di gambar, kalimat yang sepola dengan kalimat (4) adalah kalimat ke",
    type: "numeric",
    image: "images/questions/rapih.png",
    correctAnswer: "2",
    explanation:
      "Kalimat yang sepola dengan kalimat (4) adalah kalimat (5), karena sama-sama menjelaskan dampak spesifik dari kudeta terhadap sektor energi.",
  },
  {
    id: 20,
    ...
    correctAnswer: "C",
    explanation:
      "Kalimat (3) menggunakan kata yang tidak sesuai konteks seperti 'meningkatkan tekanan' → makna tidak logis.",
  },
]
