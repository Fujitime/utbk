...
import { BookOpen, Brain, Sparkles, Bot, ChevronRight, Award } from "lucide-react"
          ...
          <div>
            <Link href="/register?mode=builtin" passHref>
              <Button
                variant="outline"
                size="sm"
                className="text-blue-400 border-blue-400 hover:bg-blue-400 hover:text-white hover:shadow-lg transition duration-200"
              >
                Mulai Sekarang
              </Button>
            </Link>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-slate-400">
                <li>
                  <Link href="/register?mode=builtin" className="hover:text-white transition-colors">
                    Tryout Lengkap
                  </Link>
                </li>
                <li>
                  <Link href="/register?mode=builtin&practice=true" className="hover:text-white transition-colors">
                    Latihan Mini
                  </Link>
                </li>
                <li>
